...
const questions = [
    ...
    { q: "What is the correct syntax for a empty or self-closing tag in HTML?", options: ["<code>&lt;tagName/&gt;</code>", "<code>&lt;tagName&gt; Content &lt;/tagName&gt;</code>", "<code>&lt;br/&gt;</code>"], answer: 0 },
...
function submitQuiz() {
  ...
  let message = '';
  if (score === questions.length) message = '<span class="green">Perfect Score! 🎉</span>';
  else if (score >= 25) message = '<span class="green">Excellent Work! You can go for CSS</span>';
  else if (score >= 15) message = '<span class="orange">Good Job! You can go for CSS but keep practicing HTML</span>';
  else message = '<span class="red"> You are not ready for CSS , Keep Practicing!</span>';
